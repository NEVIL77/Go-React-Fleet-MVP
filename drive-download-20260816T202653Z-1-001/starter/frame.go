// Package fleet holds reference types for the telemetry frame and the alert you
// will produce. Generated from the dataset, so the field names match exactly.
// Adapt freely or delete - this is a convenience, not a requirement.
// Run gofmt on it; the generator does not align columns.
package fleet
